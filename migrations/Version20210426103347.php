 ...
 */
final class Version20210426103347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE olympic (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(500) NOT NULL, type SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE olympic_language (olympic_id INT NOT NULL, language_id INT NOT NULL, INDEX IDX_782C0D8BFDCBE97 (olympic_id), INDEX IDX_782C0D8B82F1BAF4 (language_id), PRIMARY KEY(olympic_id, language_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question_option (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, is_correct TINYINT(1) NOT NULL, text LONGTEXT DEFAULT NULL, type SMALLINT NOT NULL, INDEX IDX_5DDB2FB81E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tour (id INT AUTO_INCREMENT NOT NULL, olympic_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, started_at DATETIME DEFAULT NULL, expired_at DATETIME DEFAULT NULL, published_at DATETIME DEFAULT NULL, tour_index SMALLINT NOT NULL, INDEX IDX_6AD1F969FDCBE97 (olympic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE olympic_language ADD CONSTRAINT FK_782C0D8BFDCBE97 FOREIGN KEY (olympic_id) REFERENCES olympic (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE olympic_language ADD CONSTRAINT FK_782C0D8B82F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE tour ADD CONSTRAINT FK_6AD1F969FDCBE97 FOREIGN KEY (olympic_id) REFERENCES olympic (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE olympic_language DROP FOREIGN KEY FK_782C0D8B82F1BAF4');
        ...
        $this->addSql('ALTER TABLE olympic_language DROP FOREIGN KEY FK_782C0D8BFDCBE97');
        $this->addSql('ALTER TABLE tour DROP FOREIGN KEY FK_6AD1F969FDCBE97');
        ...
        $this->addSql('DROP TABLE olympic');
        $this->addSql('DROP TABLE olympic_language');
